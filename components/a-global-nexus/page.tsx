        ...
        <article className="relative z-20 bg-white pt-16 pb-24 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto space-y-12 text-slate-700 leading-relaxed">
            ...
            <div>
              ...
              <p className="italic border-l-4 border-amber-500 pl-4 text-slate-500">
            ...
            <div className="bg-slate-50 p-8 rounded-2xl border border-slate-100">
              ...
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                 <li className="flex items-center gap-2"><span className="w-2 h-2 bg-amber-500 rounded-full"></span> <strong>Seamless Access:</strong> Outer Ring Road (ORR) & Old Mumbai Highway</li>
                 <li className="flex items-center gap-2"><span className="w-2 h-2 bg-amber-500 rounded-full"></span> <strong>Key Hubs:</strong> Gachibowli, HITEC City, Kokapet & Nanakramguda</li>
                 <li className="flex items-center gap-2"><span className="w-2 h-2 bg-amber-500 rounded-full"></span> <strong>Global Travel:</strong> Quick drive to Rajiv Gandhi International Airport</li>
                 <li className="flex items-center gap-2"><span className="w-2 h-2 bg-amber-500 rounded-full"></span> <strong>Lifestyle:</strong> Upscale retail, healthcare & fine-dining avenues</li>
              </ul>
            ...
            <div className="border-t border-b border-slate-200 py-12">
              ...
              <div className="space-y-8">
                <div>
                  <h5 className="font-bold text-lg text-slate-800 mb-2">1. What makes the location of Pavani Mirai a strategic advantage?</h5>
                  <p className="text-slate-600">Pavani Mirai’s location in Hyderabad’s Financial District places residents at the core of the city’s corporate and cultural pulse. The project enjoys close proximity to major tech campuses, international schools, and entertainment hubs. With seamless connectivity via ORR and Old Mumbai Highway, residents can move effortlessly between work, leisure, and travel destinations.</p>
                </div>
                <div>
                  <h5 className="font-bold text-lg text-slate-800 mb-2">2. Is Pavani Mirai close to major tech and corporate campuses?</h5>
                  <p className="text-slate-600">Yes. Pavani Mirai is situated just minutes away from renowned corporate offices such as Amazon Hyderabad, Capgemini, Cognizant, Microsoft, and Deloitte, as well as prestigious institutions like ISB. Its location makes it ideal for professionals who value shorter commutes and an elevated quality of life.</p>
                </div>
                <div>
                  <h5 className="font-bold text-lg text-slate-800 mb-2">3. How is the connectivity to the rest of Hyderabad?</h5>
                  <p className="text-slate-600">Pavani Mirai offers unmatched connectivity. The Outer Ring Road provides quick access to all major destinations, including the airport, Gachibowli, HITEC City, and Kokapet. This ease of movement ensures residents can experience the best of both urban convenience and serene living - all from one address.</p>
                </div>
              </div>
            </div>

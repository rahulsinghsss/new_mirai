        ...
        <div className="max-w-4xl mx-auto space-y-12 text-black leading-relaxed">
          ...
          <div className="bg-neutral-50 p-8 rounded-2xl border border-black/10">
            ...
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
               <li className="flex items-center gap-2 text-black/80"><span className="w-2 h-2 bg-[#78252f] rounded-full"></span> Foyer Lobby & Formal Lounge</li>
               <li className="flex items-center gap-2 text-black/80"><span className="w-2 h-2 bg-[#78252f] rounded-full"></span> Expansive Living Room</li>
               <li className="flex items-center gap-2 text-black/80"><span className="w-2 h-2 bg-[#78252f] rounded-full"></span> Master Suite Retreat</li>
               <li className="flex items-center gap-2 text-black/80"><span className="w-2 h-2 bg-[#78252f] rounded-full"></span> Private Home Theatre</li>
               <li className="flex items-center gap-2 text-black/80"><span className="w-2 h-2 bg-[#78252f] rounded-full"></span> Family Deck & Balcony</li>
               <li className="flex items-center gap-2 text-black/80"><span className="w-2 h-2 bg-[#78252f] rounded-full"></span> Dedicated Helper's Room</li>
            </ul>

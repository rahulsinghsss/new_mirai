    ...
    <>
      ...
      <main ref={mainRef}>
        ...
        <section ref={heroRef} className="relative bg-white overflow-hidden">
          ...
          {/* Head Text Overlay */}
          <div
            className={`absolute inset-0 flex flex-col items-center justify-start pt-8 lg:pt-12 text-center px-4 z-10 transition-opacity duration-700 ${
          ...
          >
            ...
            <div className="w-full flex items-center justify-center gap-6 lg:gap-8 mb-8 lg:mb-12 px-4">
              <div className="flex-1 h-[1px] bg-white shadow-lg"></div>
              <img 
                    ...
                    <>
                      ...
                      <div className="flex flex-col justify-center px-4 lg:px-8">
                        <div className="space-y-4 lg:space-y-6 lg:pl-8">
                          <h3 className="text-2xl lg:text-3xl font-serif leading-tight transition-colors duration-300 cursor-pointer" style={{ color: '#78252f' }}>
                            <Link href={post.href} className="hover:text-black">
                              {post.title}
                            </Link>
                          </h3>
